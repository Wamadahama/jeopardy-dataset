...
def update_metadata(latest_id):
    with open(METADATA_FILE, "w", encoding="utf-8") as f:
        f.write("Date: {}\n".format(date.today()))
        f.write("Count: {}".format(latest_id))
...
def main_2():
    ...
    if last_id == latest_id:
        ...
        update_metadata(latest_id)

if __name__ == "__main__":
    def main():
        import timeit
        print(timeit.timeit("main_2()", setup="from __main__ import main_2", number=20))
